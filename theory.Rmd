...
\begin{align}
E(U(X, Y))
&= \int_0^1 \int_0^1 U(x, y) f(x, y) dy dx \\
...
\begin{align}
E(U(X, Y)) =
& g \int_0^1 \int_x^1 y f(x, y) dy dx - g \int_0^1 \int_x^1 x f(x, y) dy dx + {} \\
...
$$
E(U(X, Y)) = g \, G_1 - g \, G_2 + l \, L_1 - l \, L_2.
$$
...
&=
\frac{B(\alpha_y + 1, \beta_y)}{B(\alpha_y, \beta_y)}
(1 - h(\alpha_x, \beta_x, \alpha_y + 1, \beta_y)) -
\frac{B(\alpha_x + 1, \beta_x)}{B(\alpha_x, \beta_x)}
(1 - h(\alpha_x + 1, \beta_x, \alpha_y, \beta_y)) \\
&=
\frac{B(\alpha_y + 1, \beta_y)}{B(\alpha_y, \beta_y)} -
\frac{B(\alpha_x + 1, \beta_x)}{B(\alpha_x, \beta_x)} -
(L_1 - L_2) \\
